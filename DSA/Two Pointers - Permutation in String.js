var checkInclusion = function(s1, s2) {
    ...
    while(r<s2.length) {
        let curr = s2[r]
        if(hm_s1.hasOwnProperty(curr)) {

            if(hm_s2.hasOwnProperty(curr)) {
                hm_s2[curr]+=1
            }else{
                hm_s2[curr] = 1
            }

            if(hm_s1.hasOwnProperty(s2[l]) && hm_s2[s2[l]] > hm_s1[s2[l]]) {
                hm_s2[s2[l]] -= 1
                l+=1
            }
            if(hm_s2[curr] > hm_s1[curr]) {
                hm_s2 = {}
                hm_s2[curr] = hm_s1[curr]
                let curDist = r-l+1
                l+=curDist - hm_s1[curr]
            }
            if(r-l+1 == s1.length) {
                console.log(hm_s2)
                return true
